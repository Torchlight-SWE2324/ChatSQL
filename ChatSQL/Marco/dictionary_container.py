...
class DictionaryContainer():
    ...
    def __get_dictionaries_folder_path(self) -> str: #---OK---
        return os.path.join(os.path.dirname(os.path.realpath(__file__)), "dictionaries")

    def __get_dictionary_service_file_path(self) -> str: #---OK---
        dictionaries_folder_path = self.__get_dictionaries_folder_path()
    ...
    def __is_dictionary_present(self, dictionary_name: str) -> bool: #---OK---
    ...
    def get_all_dictionaries_names(self): #---OK---
        '''
        dictionaries_list = []
    ...
    def get_dictionaries_number(self) -> int: #---OK---
        return len(self.get_all_dictionaries_names())

    def get_dictionary_path(self, dictionary_name: str) -> str: #---OK---
